"""
Django settings for jyoti_saree_proj project.
...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-@j1-%i5=$a+x@-t^4o!16phwyg)*sua_)aru3v7t#rqq%+in@)")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get("DEBUG", "True").lower() in ("true", "1", "yes")

ALLOWED_HOSTS = os.environ.get("ALLOWED_HOSTS", "187.127.160.134,localhost,127.0.0.1").split(",")
...
ROOT_URLCONF = "jyoti_saree_proj.urls"
...
WSGI_APPLICATION = "jyoti_saree_proj.wsgi.application"
